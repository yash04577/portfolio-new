...
const JobExperienceCard = ({primaryTitle, secondaryTitle, place, date, description}: Props) => {
  return (
    <div className='w-[700px] px-5 min-h-[300px] py-10 relative flex flex-col justify-center gap-10 shadow-skill-card  items-center rounded-lg hover:bg-[#191b1e] transition-colors duration-700'>
        <div className='border-l-8 border-[#191b1e] absolute w-[700px] px-5 h-[300px] left-[-50px]'></div>
