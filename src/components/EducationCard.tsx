...
const EducationCard = ({primaryTitle, secondaryTitle, place, date}: Props) => {
  return (
    <div className='sm:w-[400px] w-[370px] px-10 h-[300px] flex justify-between shadow-skill-card  items-center rounded-lg hover:bg-[#191b1e] transition-colors duration-700'>
        <div>
